...
const BOT_IMG = "bot1.png";
const PERSON_IMG = "Profile.jpeg";
const BOT_NAME = "FREDA";
const PERSON_NAME = "Prasad";
...
window.addEventListener('load', () => {
  ...
  if (chatHistory.length === 0) {
    const welcomeMessage = "Hi, welcome to the chat! My name is Freda. \n Greetings! I'm here to help. What can I assist you with?\n  Please feel free to send me a message. 😄";
